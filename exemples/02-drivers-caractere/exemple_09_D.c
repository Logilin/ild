/************************************************************************\
  exemple_09_D - Chapitre "Ecriture de driver - peripherique caractere"

  Driver permettant les entrees-sorties sur GPIO du SoCFPGA Cyclone V
...
#include <asm/uaccess.h>
	...
	// Sortie sur la led "user"
	#define GPIO_OUT 222

	// Entree sur bouton-poussoir "user"
	#define GPIO_IN  223
